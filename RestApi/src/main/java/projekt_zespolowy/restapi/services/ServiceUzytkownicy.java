...
public class ServiceUzytkownicy {
    ...
    public Response add(String incomingData) {
        ...
        return Response.status(httpCode).entity("Operacja dodania uzytkownika nie powiodla sie").build();
    }
    ...
    public Response updateEmail(String incomingData) {
        ...
        return Response.status(httpCode).entity("Operacja aktualizacji adresu e-mail nie powiodla sie").build();
    }
